...
export function renderLogin(root: HTMLElement): void {
    root.innerHTML = `
        <div class="screen-login">
            ${stepIndicator(1)}
            <h1 class="login-title">VALORANT Open Store Login</h1>
            <button id="btn-login" aria-label="Login with Discord">
    ...
    const btn = root.querySelector<HTMLButtonElement>("#btn-login")!;
