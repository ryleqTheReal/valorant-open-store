...
// ======= END ICONS =======
// ======= START LOGOUT MODAL =======
function openLogoutModal(root, onConfirm) {
...
// ======= END LOGOUT MODAL =======
export async function showAccounts(root) {
...
function render(root) {
    ...
    root.querySelector("#discord-avatar").addEventListener("click", () => {
    ...
    root.querySelector("#btn-add").addEventListener("click", async () => {
        try {
            ...
            if (msg.includes("window closed before auth"))
                return;
